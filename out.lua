...
local function main()
	...
	Explorer.ShowRightClick = function(MousePos)
		...
		if presentClasses["BasePart"] or presentClasses["Model"] then
			...
			context:AddRegistered("TELEPORT_ALL_TO")
	...
	Explorer.InitRightClick = function()
			...
			OnClick = function()
				...
				for i = 1, #sList do
					...
					if obj and obj.Parent then
						task.spawn(function()
							pcall(function()
								endpoint:InvokeServer("Remove", {obj})
							end)
						end)
					end
				end
		...
		context:Register("TELEPORT_ALL_TO",{Name = "Teleport All To", IconMap = Explorer.MiscIcons, Icon = "TeleportTo", OnClick = function()
			local sList = selection.List
			local plrRP = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
